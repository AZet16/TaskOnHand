...
* The original package name 'com.example.spring-boot-3-1-1-tasksonhand-applicaton' is invalid and this project uses 'com.example.springboot311tasksonhandapplicaton' instead.
...
```
$ docker run --rm -p 8080:8080 spring-boot-3-1-1-tasksonhand-applicaton:0.0.1-SNAPSHOT
```
...
```
$ target/spring-boot-3-1-1-tasksonhand-applicaton
```
